...
{    
    /// <summary>
    /// A class which represents the Report_Day table in the HKHR Database.
    /// </summary>
    public partial class Report_Day: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<Report_Day>(new Solution.DataAccess.DataModel.HKHRDB());
        }
