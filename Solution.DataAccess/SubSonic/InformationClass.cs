...
{    
    /// <summary>
    /// A class which represents the InformationClass table in the HKHR Database.
    /// </summary>
    public partial class InformationClass: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<InformationClass>(new Solution.DataAccess.DataModel.HKHRDB());
        }
