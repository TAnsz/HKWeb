...
{    
    /// <summary>
    /// A class which represents the CardDetail table in the HRtest Database.
    /// </summary>
    public partial class CardDetail: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<CardDetail>(new Solution.DataAccess.DataModel.HRtestDB());
        }
