...
{    
    /// <summary>
    /// A class which represents the employeedet table in the HRtest Database.
    /// </summary>
    public partial class employeedet: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<employeedet>(new Solution.DataAccess.DataModel.HRtestDB());
        }
