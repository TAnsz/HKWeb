...
{    
    /// <summary>
    /// A class which represents the Report_Month table in the HRtest Database.
    /// </summary>
    public partial class Report_Month: IActiveRecord
    {
    
        #region Built-in testing
        static TestRepository<Report_Month> _testRepo;
        

        
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<Report_Month>(new Solution.DataAccess.DataModel.HRtestDB());
        }
        public static void ResetTestRepo(){
            _testRepo = null;
            SetTestRepo();
        }
        public static void Setup(List<Report_Month> testlist){
            SetTestRepo();
        ...
        public static void Setup(Report_Month item) {
            SetTestRepo();
            _testRepo._items.Add(item);
        }
        public static void Setup(int testItems) {
            ...
            for(int i=0;i<testItems;i++){
                Report_Month item=new Report_Month();
                _testRepo._items.Add(item);
            }
        }
        ...
        IRepository<Report_Month> _repo;
        ITable tbl;
        bool _isNew;
        public bool IsNew(){
            return _isNew;
        ...
        public Report_Month(string connectionString, string providerName) {
        ...
        void Init(){
            ...
            if(TestMode){
                Report_Month.SetTestRepo();
                _repo=_testRepo;
            }else{
                _repo = new SubSonicRepository<Report_Month>(_db);
            }
            tbl=_repo.GetTable();
            SetIsNew(true);
            OnCreated();       
		...
		public void ORMapping(IDataRecord dataRecord)
        {
            ...
            YM = readRecord.get_string("YM",null);
            ...
            auditor = readRecord.get_string("auditor",null);
               
            audit_date = readRecord.get_datetime("audit_date",null);
               
            update_date = readRecord.get_datetime("update_date",null);
               
            month_days = readRecord.get_short("month_days",null);
            ...
            cal_days = readRecord.get_decimal("cal_days",null);
            ...
            sign_count = readRecord.get_int("sign_count",null);
        ...
        public Report_Month(Expression<Func<Report_Month, bool>> expression):this() {
        ...
        internal static IRepository<Report_Month> GetRepo(string connectionString, string providerName){
            ...
            if(db.TestMode){
                ...
                _repo = new SubSonicRepository<Report_Month>(db);
            }
            return _repo;        
        }       
        
        internal static IRepository<Report_Month> GetRepo(){
            return GetRepo("","");
        }
        
        public static Report_Month SingleOrDefault(Expression<Func<Report_Month, bool>> expression) {

            var repo = GetRepo();
            var results=repo.Find(expression);
            Report_Month single=null;
            if(results.Count() > 0){
        ...
        public static Report_Month SingleOrDefault(Expression<Func<Report_Month, bool>> expression,string connectionString, string providerName) {
        ...
        public static bool Exists(Expression<Func<Report_Month, bool>> expression,string connectionString, string providerName) {
           
            return All(connectionString,providerName).Any(expression);
        }        
        public static bool Exists(Expression<Func<Report_Month, bool>> expression) {
           
            return All().Any(expression);
        }        

        public static IList<Report_Month> Find(Expression<Func<Report_Month, bool>> expression) {
            
            var repo = GetRepo();
            return repo.Find(expression).ToList();
        }
        
        public static IList<Report_Month> Find(Expression<Func<Report_Month, bool>> expression,string connectionString, string providerName) {

            var repo = GetRepo(connectionString,providerName);
            return repo.Find(expression).ToList();

        }
        public static IQueryable<Report_Month> All(string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetAll();
        }
        public static IQueryable<Report_Month> All() {
            return GetRepo().GetAll();
        }
        
        public static PagedList<Report_Month> GetPaged(string sortBy, int pageIndex, int pageSize,string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetPaged(sortBy, pageIndex, pageSize);
        }
      
        public static PagedList<Report_Month> GetPaged(string sortBy, int pageIndex, int pageSize) {
            return GetRepo().GetPaged(sortBy, pageIndex, pageSize);
        }

        public static PagedList<Report_Month> GetPaged(int pageIndex, int pageSize,string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetPaged(pageIndex, pageSize);
            
        }


        public static PagedList<Report_Month> GetPaged(int pageIndex, int pageSize) {
        ...
        public override bool Equals(object obj){
            if(obj.GetType()==typeof(Report_Month)){
                Report_Month compare=(Report_Month)obj;
        ...
        public string YM
        {
            ...
            set
            {
                if(_YM!=value || _isLoaded){
                    _YM=value;
                    var col=tbl.Columns.SingleOrDefault(x=>x.Name=="YM");
                    if(col!=null){
                        if(!_dirtyColumns.Any(x=>x.Name==col.Name) && _isLoaded){
                            _dirtyColumns.Add(col);
                        }
        ...
        public DateTime? audit_date
        {
            ...
            set
            {
                if(_audit_date!=value || _isLoaded){
                    _audit_date=value;
                    var col=tbl.Columns.SingleOrDefault(x=>x.Name=="audit_date");
                    if(col!=null){
                        if(!_dirtyColumns.Any(x=>x.Name==col.Name) && _isLoaded){
                            _dirtyColumns.Add(col);
                        }
        ...
        public DateTime? update_date
        {
            ...
            set
            {
                if(_update_date!=value || _isLoaded){
                    _update_date=value;
                    var col=tbl.Columns.SingleOrDefault(x=>x.Name=="update_date");
                    if(col!=null){
                        if(!_dirtyColumns.Any(x=>x.Name==col.Name) && _isLoaded){
                            _dirtyColumns.Add(col);
                        }
		...
		/// 
		/// </summary>
        public short? month_days
        {
            get { return _month_days; }
            set
            {
                if(_month_days!=value || _isLoaded){
                    _month_days=value;
                    var col=tbl.Columns.SingleOrDefault(x=>x.Name=="month_days");
                    if(col!=null){
                        if(!_dirtyColumns.Any(x=>x.Name==col.Name) && _isLoaded){
                            _dirtyColumns.Add(col);
                        }
		...
		/// 
		/// </summary>
        public decimal? cal_days
        {
            get { return _cal_days; }
            set
            {
                if(_cal_days!=value || _isLoaded){
                    _cal_days=value;
                    var col=tbl.Columns.SingleOrDefault(x=>x.Name=="cal_days");
                    if(col!=null){
                        if(!_dirtyColumns.Any(x=>x.Name==col.Name) && _isLoaded){
                            _dirtyColumns.Add(col);
                        }
        ...
        public static void Delete(Expression<Func<Report_Month, bool>> expression) {
            var repo = GetRepo();
