...
{    
    /// <summary>
    /// A class which represents the PagePowerSign table in the HRtest Database.
    /// </summary>
    public partial class PagePowerSign: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<PagePowerSign>(new Solution.DataAccess.DataModel.HRtestDB());
        }
