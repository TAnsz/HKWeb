...
{    
    /// <summary>
    /// A class which represents the OutWork_D table in the HKHR Database.
    /// </summary>
    public partial class OutWork_D: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<OutWork_D>(new Solution.DataAccess.DataModel.HKHRDB());
        }
