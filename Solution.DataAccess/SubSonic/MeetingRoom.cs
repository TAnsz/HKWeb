...
{    
    /// <summary>
    /// A class which represents the MeetingRoom table in the HRtest Database.
    /// </summary>
    public partial class MeetingRoom: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<MeetingRoom>(new Solution.DataAccess.DataModel.HRtestDB());
        }
