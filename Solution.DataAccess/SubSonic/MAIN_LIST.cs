...
{    
    /// <summary>
    /// A class which represents the MAIN_LIST table in the HKHR Database.
    /// </summary>
    public partial class MAIN_LIST: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<MAIN_LIST>(new Solution.DataAccess.DataModel.HKHRDB());
        }
