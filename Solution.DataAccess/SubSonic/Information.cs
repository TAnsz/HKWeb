...
{    
    /// <summary>
    /// A class which represents the Information table in the HKHR Database.
    /// </summary>
    public partial class Information: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<Information>(new Solution.DataAccess.DataModel.HKHRDB());
        }
