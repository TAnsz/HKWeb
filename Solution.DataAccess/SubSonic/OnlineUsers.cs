...
{    
    /// <summary>
    /// A class which represents the OnlineUsers table in the HRtest Database.
    /// </summary>
    public partial class OnlineUsers: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<OnlineUsers>(new Solution.DataAccess.DataModel.HRtestDB());
        }
