...
{    
    /// <summary>
    /// A class which represents the RoomMoment table in the HKHR Database.
    /// </summary>
    public partial class RoomMoment: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<RoomMoment>(new Solution.DataAccess.DataModel.HKHRDB());
        }
