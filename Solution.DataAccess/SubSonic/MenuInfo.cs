...
{    
    /// <summary>
    /// A class which represents the MenuInfo table in the HKHR Database.
    /// </summary>
    public partial class MenuInfo: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<MenuInfo>(new Solution.DataAccess.DataModel.HKHRDB());
        }
