...
{    
    /// <summary>
    /// A class which represents the USERAUTHORITY table in the HRtest Database.
    /// </summary>
    public partial class USERAUTHORITY: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<USERAUTHORITY>(new Solution.DataAccess.DataModel.HRtestDB());
        }
