...
{    
    /// <summary>
    /// A class which represents the USERAUTHORITY_REPORT table in the HRtest Database.
    /// </summary>
    public partial class USERAUTHORITY_REPORT: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<USERAUTHORITY_REPORT>(new Solution.DataAccess.DataModel.HRtestDB());
        }
