...
{    
    /// <summary>
    /// A class which represents the ErrorLog table in the HRtest Database.
    /// </summary>
    public partial class ErrorLog: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<ErrorLog>(new Solution.DataAccess.DataModel.HRtestDB());
        }
