...
{    
    /// <summary>
    /// A class which represents the UploadFile table in the HKHR Database.
    /// </summary>
    public partial class UploadFile: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<UploadFile>(new Solution.DataAccess.DataModel.HKHRDB());
        }
