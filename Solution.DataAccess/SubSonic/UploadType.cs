...
{    
    /// <summary>
    /// A class which represents the UploadType table in the HKHR Database.
    /// </summary>
    public partial class UploadType: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<UploadType>(new Solution.DataAccess.DataModel.HKHRDB());
        }
