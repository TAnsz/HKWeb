...
{    
    /// <summary>
    /// A class which represents the MeetingRoomApply table in the HRtest Database.
    /// </summary>
    public partial class MeetingRoomApply: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<MeetingRoomApply>(new Solution.DataAccess.DataModel.HRtestDB());
        }
