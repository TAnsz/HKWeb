...
{    
    /// <summary>
    /// A class which represents the T_TABLE_D table in the HKHR Database.
    /// </summary>
    public partial class T_TABLE_D: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<T_TABLE_D>(new Solution.DataAccess.DataModel.HKHRDB());
        }
