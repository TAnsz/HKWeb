...
{    
    /// <summary>
    /// A class which represents the MealOrdering table in the HKHR Database.
    /// </summary>
    public partial class MealOrdering: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<MealOrdering>(new Solution.DataAccess.DataModel.HKHRDB());
        }
