...
{    
    /// <summary>
    /// A class which represents the T_TABLESET table in the HKHR Database.
    /// </summary>
    public partial class T_TABLESET: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<T_TABLESET>(new Solution.DataAccess.DataModel.HKHRDB());
        }
