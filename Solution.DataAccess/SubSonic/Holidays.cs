...
{    
    /// <summary>
    /// A class which represents the Holidays table in the HRtest Database.
    /// </summary>
    public partial class Holidays: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<Holidays>(new Solution.DataAccess.DataModel.HRtestDB());
        }
