<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActiveFileClassList.aspx.cs" Inherits="Solution.Web.Managers.WebManage.ActiveFiles.ActiveFileClassList" %>
...
<body>
    ...
    <f:panel id="Panel1" runat="server" title="文件類型列表" enableframe="false" bodypadding="10px"
        enablecollapse="True">
        <toolbars>
        ...
        <items>
             <f:SimpleForm ID="SimpleForm1" BodyPadding="5px" runat="server" EnableFrame="false" EnableCollapse="true"
                ...
                <Items>
                    <f:DropDownList Label="文件類型選擇" runat="server" ID="ddlParentId" Width="250px"></f:DropDownList>
                </Items>
            </f:SimpleForm>
            <f:Grid ID="Grid1" Title="文件類型列表" EnableFrame="false" EnableCollapse="true" AllowSorting="true" Height="420px"
            ...
            OnPageIndexChange="Grid1_PageIndexChange" OnPreRowDataBound="Grid1_PreRowDataBound" OnRowCommand="Grid1_RowCommand">
                <Columns>
                    <f:BoundField DataField="Id" HeaderText="ID" Width="50px" />
