<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DepartsList.aspx.cs" Inherits="Solution.Web.Managers.WebManage.Systems.Powers.DepartsList" %>
...
<body>
    ...
    <f:panel id="Panel1" runat="server" title="部門列表" enableframe="false" bodypadding="10px"
        enablecollapse="True">
        <toolbars>
        ...
        <items>
             <%--<f:SimpleForm ID="SimpleForm1" BodyPadding="5px" runat="server" EnableFrame="false" EnableCollapse="true"
                ...
                <Items>
                    <f:DropDownList Label="部門選擇" runat="server" ID="ddlParentId" Width="400px"></f:DropDownList>
                </Items>
            </f:SimpleForm>--%>
            ...
            OnPageIndexChange="Grid1_PageIndexChange" OnPreRowDataBound="Grid1_PreRowDataBound" OnRowCommand="Grid1_RowCommand">
                <Columns>
                    <f:RowNumberField />
                    <f:BoundField Width="180px" DataField="depart_id" DataSimulateTreeLevelField="Depth" HeaderText="部門名稱" />
                    <f:BoundField Width="180px" DataField="depart_name" HeaderText="部門編碼" />
                    <f:BoundField Width="250px" DataField="remark" HeaderText="備註" ExpandUnusedSpace="true" />
                    <f:TemplateField HeaderText="排序" Width="100px">
                        <ItemTemplate>
                            <asp:TextBox ID="tbSort" runat="server" Width="50px" Text='<%# Eval("inside_id") %>' AutoPostBack="false"></asp:TextBox>
                        </ItemTemplate>
                    </f:TemplateField>
                    <f:BoundField DataField="TreeLevel" HeaderText="級別層次" TextAlign="Center" />
    ...
    <f:window id="Window1" width="380px" height="350px" icon="TagBlue" title="編輯" hidden="True"
