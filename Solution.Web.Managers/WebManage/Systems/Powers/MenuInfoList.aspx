    ...
    <f:panel id="Panel1" runat="server" title="菜單(頁面)列表" enableframe="false" bodypadding="10px"
        ...
        <items>
             <f:SimpleForm ID="SimpleForm1" BodyPadding="5px" runat="server" EnableFrame="false" EnableCollapse="true"
                ...
                <Items>
                    <f:DropDownList Label="菜單選擇" runat="server" ID="ddlParentId" Width="250px"></f:DropDownList>
                </Items>
            </f:SimpleForm>
            <f:Grid ID="Grid1" Title="菜單列表" EnableFrame="false" EnableCollapse="true" AllowSorting="true"
            ...
            OnPageIndexChange="Grid1_PageIndexChange" OnPreRowDataBound="Grid1_PreRowDataBound" OnRowCommand="Grid1_RowCommand">
                <Columns>
                    <f:RowNumberField />
                    <f:BoundField Width="180px" DataField="Name" DataFormatString="{0}" DataSimulateTreeLevelField="Depth" HeaderText="菜單(頁面)名" />
                    <f:BoundField DataField="Url" HeaderText="訪問路徑" ExpandUnusedSpace="true" />
                    ...
                    <f:LinkButtonField HeaderText="是否頁面" Icon="BulletCross" TextAlign="Center" ToolTip="點擊修改是否頁面" ColumnID="IsMenu" CommandName="IsMenu" />
