...
{
    public partial class MeetingRoomList : PageBase
    {
        #region Page_Load
        ...
        public override void LoadData()
        {
            ...
            //綁定Grid表格
            if (bll != null) bll.BindGrid(Grid1, Grid1.PageIndex + 1, Grid1.PageSize, null, null);
        }
        ...
        protected void Grid1_PreRowDataBound(object sender, FineUI.GridPreRowEventArgs e)
        {
            ...
            if (row != null)
            {
                ...
                //綁定是否有效列
                if (row.Row.Table.Rows[e.RowIndex][MeetingRoomTable.IsVaild].ToString() == "0")
                {
        ...
        protected void Grid1_RowCommand(object sender, FineUI.GridCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                case "IsVaild":
                    //更新狀態
                    MeetingRoomBll.GetInstence().UpdateIsVaild(this, ConvertHelper.Cint0(id), ConvertHelper.Cint0(e.CommandArgument));
                    //重新加載
                    LoadData();
                ...
                case "ButtonEdit":
                    //打開編輯窗口
                    Window1.IFrameUrl = "MeetingRoomEdit.aspx?Id=" + id + "&" + MenuInfoBll.GetInstence().PageUrlEncryptStringNoKey(id + "");
        ...
        {
            Window1.IFrameUrl = "MeetingRoomEdit.aspx?" + MenuInfoBll.GetInstence().PageUrlEncryptString();
            Window1.Hidden = false;
        }
        #endregion
