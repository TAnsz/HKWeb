                    ...
                    <f:Form ID="extForm1" ShowBorder="false" ShowHeader="false" BodyPadding="5px" runat="server">
                        <Rows>
                            <f:FormRow ID="FormRow1" runat="server">
                                <Items>
                                    <f:TextBox runat="server" ID="txtName" Label="廣告名稱" Width="300px" Text="" ShowRedStar="true"
                                        MaxLength="50" />
                            ...
                            <f:FormRow ID="FormRow2" runat="server">
                                <Items>
                                    <f:DropDownList Label="廣告位置" AutoPostBack="true" CompareType="String" EnableSimulateTree="true"
                                    ...
                                    <f:RadioButtonList ID="rblIsDisplay" Label="是否審核" ColumnNumber="2" runat="server"
                                        Width="300px">
                            ...
                            <f:FormRow ID="FormRow11" runat="server">
                                <Items>
                                    <f:TextBox runat="server" ID="txtUrl" Label="廣告鏈接地址" Width="610px" Text="" MaxLength="200" />
                                </Items>
                            </f:FormRow>
                            ...
                            <f:FormRow ID="FormRow10" runat="server">
                                <Items>
                                    <f:FileUpload runat="server" ID="filePhoto" Label="廣告圖片" Width="300px" />
